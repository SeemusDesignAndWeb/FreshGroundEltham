...
<section class="py-16 px-4 bg-white">
	<div class="max-w-7xl mx-auto">
		...
		<div class="max-w-3xl mx-auto text-center text-gray-700 space-y-4 mb-12">
			<p class="text-xl">
				Fresh Ground is a welcoming community café offering quality food and beverages at accessible prices. We're run by Eltham Green Community Church and strive to create a safe and enjoyable environment for all ages.
			</p>
			<p class="text-xl">
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
			<div class="bg-white rounded-lg p-6 text-center shadow-md hover:shadow-lg transition-shadow border border-gray-200">
...
<!-- Newsletter & Activities Section -->
<section class="py-16 px-4 bg-white">
	<div class="max-w-7xl mx-auto">
		<div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
			<div class="bg-white rounded-lg p-6 shadow-md border border-gray-200 hover:shadow-lg transition-shadow">
				<h2 class="text-4xl font-bold text-[#39918c] mb-3">Stay Connected</h2>
				<p class="text-gray-600 mb-4 text-xl">Subscribe to our newsletter for updates, special offers, and community news.</p>
				<form class="space-y-3">
					<input 
						type="email" 
						placeholder="Your email address" 
						class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#39918c] text-base"
						required
					/>
					<button type="submit" class="w-full bg-[#39918c] text-white px-4 py-2 rounded hover:bg-[#ab6b51] transition-colors text-lg font-medium">
						Subscribe
					</button>
				</form>
			</div>
			<div class="bg-gradient-to-br from-[#39918c] to-[#2f435a] rounded-lg p-6 shadow-md text-white">
				<h2 class="text-4xl font-bold mb-3">Kids Activities</h2>
				<p class="mb-4 text-gray-100 text-xl">Book activities for children during half term and school holidays. Get in touch with us to find out more.</p>
				<a href="/activities" class="inline-block bg-white text-[#39918c] px-6 py-2 rounded hover:bg-gray-100 transition-colors text-lg font-medium w-full text-center">
					View Activities →
				</a>
			</div>
		</div>
