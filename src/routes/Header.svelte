		...
		<div class="bg-[#2f435a] py-2 px-4 border-b border-[#39918c]/30 w-full">
			<div class="max-w-7xl mx-auto flex justify-between items-center">
				<div class="flex items-center gap-4">
					<a href="https://facebook.com" target="_blank" class="text-white hover:text-[#39918c] transition-colors" aria-label="Facebook">
						<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
							<path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
						</svg>
					</a>
					<a href="https://instagram.com" target="_blank" class="text-white hover:text-[#39918c] transition-colors" aria-label="Instagram">
						<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
					...
					<button class="text-white hover:text-[#39918c] transition-colors" aria-label="Signup">
						<span class="text-sm font-medium">Signup</span>
					</button>
				</div>
					<div class="flex items-center gap-4">
						<a href="/activities" class="flex items-center gap-1 text-white hover:text-[#39918c] transition-colors" aria-label="Kids activities">
							<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
							</svg>
							<span class="text-sm font-medium">Kids Activities</span>
						</a>
						{#if cartCount > 0}
							<button 
								onclick={() => goto('/cart')}
